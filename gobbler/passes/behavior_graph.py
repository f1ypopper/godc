...
API_BEHAVIOR_HINTS = {
    ...
    "syscall.(*LazyDLL).Load": ("dynamic_library_load", "loader"),
    "syscall.GetProcAddress": ("dynamic_import_resolution", "loader"),
    "syscall.(*DLL).FindProc": ("dynamic_import_resolution", "loader"),
    "syscall.(*LazyDLL).NewProc": ("dynamic_import_resolution", "loader"),
    "syscall.(*LazyProc).Find": ("dynamic_import_resolution", "loader"),
    ...
    "golang.org/x/sys/windows.NewLazyDLL": ("dynamic_library_load", "loader"),
    "golang.org/x/sys/windows.NewLazySystemDLL": ("dynamic_library_load", "loader"),
    "golang.org/x/sys/windows.(*LazyDLL).Load": ("dynamic_library_load", "loader"),
    "golang.org/x/sys/windows.(*DLL).FindProc": ("dynamic_import_resolution", "loader"),
    "golang.org/x/sys/windows.(*LazyDLL).NewProc": ("dynamic_import_resolution", "loader"),
    "golang.org/x/sys/windows.(*LazyProc).Find": ("dynamic_import_resolution", "loader"),
    "golang.org/x/sys/windows.(*LazyProc).Call": ("dynamic_syscall_call", "execution"),
    "windows.LoadDLL": ("dynamic_library_load", "loader"),
    "windows.NewLazyDLL": ("dynamic_library_load", "loader"),
    "windows.NewLazySystemDLL": ("dynamic_library_load", "loader"),
    "windows.(*LazyDLL).Load": ("dynamic_library_load", "loader"),
    "windows.(*DLL).FindProc": ("dynamic_import_resolution", "loader"),
    "windows.(*LazyDLL).NewProc": ("dynamic_import_resolution", "loader"),
    "windows.(*LazyProc).Find": ("dynamic_import_resolution", "loader"),
    "windows.(*LazyProc).Call": ("dynamic_syscall_call", "execution"),
