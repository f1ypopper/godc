...
def feature_for_chain_kind(kind: str) -> str:
    return {
        ...
        "outbound_network_client": "outbound_network_client",
        "inbound_network_service": "inbound_network_service",
...
def features_for_operation_kind(kind: str | None) -> list[str]:
    return {
        ...
        "http_network": ["network_activity"],
        "http_request": ["outbound_network_client"],
        "http_get": ["outbound_network_client"],
        "http_post": ["outbound_network_client"],
        "file_write": ["file_write"],
